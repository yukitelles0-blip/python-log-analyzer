...
# para conseguirmos importar log_parser e analyzer aqui.
...
def test_parse_log_file_reads_sample(tmp_path):
    # tmp_path e um recurso do pytest: cria uma pasta temporaria
    # para testes, que e apagada automaticamente depois.
...
def test_detect_suspicious_ips_reaches_threshold():
    failed_counts = {"192.168.1.10": 5, "192.168.1.20": 2}
    suspicious = detect_suspicious_ips(failed_counts, threshold=5)
